...
async function main() {
  ...
  const user = await prisma.user.upsert({
    where: { email: 'demo@pythontrainer.com' },
    update: {},
    create: {
      username: 'demo_user',
...
Try it yourself!`,
      ...
      testCases: [
        {
          ...
          assertion: 'output.strip() == "Hello, World!"',
          errorMessage: 'Expected output to be "Hello, World!"',
        },
      ],
      hints: [
        'Use the print() function',
        'Remember to include the quotation marks',
        'Make sure your capitalization matches exactly',
      ],
  ...
  const challenge2 = await prisma.challenge.upsert({
    ...
    create: {
      ...
      difficulty: 'easy',
      type: 'code',
      starterCode: '# Define two variables and print their sum\n',
      solutionCode: 'a = 5\nb = 10\nprint(a + b)',
      testCases: [
        {
          name: 'Variables exist',
          setup: 'a = 5\nb = 10',
          assertion: '"a" in dir() and "b" in dir()',
          errorMessage: 'Variables a and b should be defined',
        },
      ],
      hints: [
  ...
  console.log('✅ Created achievements:', achievement1.name, achievement2.name);
